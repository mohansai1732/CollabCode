...
import { Code2, Users, Zap, Shield, Globe, Terminal } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-900 to-blue-900">
      <nav className="border-b border-white/10 backdrop-blur-xl bg-gray-900/50 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            ...
            <span className="text-xl text-white font-semibold">CollabCode</span>
          </Link>
          ...
          <div className="relative rounded-2xl border border-white/10 bg-gray-900/80 backdrop-blur-xl p-2 shadow-2xl">
            ...
            <div className="bg-gray-950 rounded-xl overflow-hidden" aria-hidden="true">
              ...
              <div className="inline text-gray-400">() {'{'}</div>
                ...
                <div className="ml-8 text-gray-500">{'//'} Tailwind utility classes</div>

                <div className="ml-8"><span className="text-green-400">flex items-center justify-center</span></div>
                <div className="ml-8"><span className="text-green-400">bg-gradient-to-r from-blue-600</span></div>
                <div className="ml-8"><span className="text-green-400">to-purple-600 text-white p-8</span></div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-14">
          <h2 className="text-4xl mb-4 text-white font-bold">Built for Modern Teams</h2>
        ...
        {features.map((feature) => {
          ...
          return (
           <div key={feature.title} className="group relative overflow-hidden p-6 rounded-2xl bg-white/[0.04] backdrop-blur-2xl
            border border-white/10 transition-all duration-300 hover:-translate-y-1 hover:border-blue-500/40 hover:bg-gradient-to-br
             hover:from-blue-500/10 hover:to-purple-500/10 hover:shadow-[0_0_35px_rgba(59,130,246,0.15)]">
              ...
              <div className="absolute -top-8 -right-8 w-24 h-24 bg-blue-500/10 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-all duration-500" />
              <div className="relative z-10 w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center mb-4 transition-all duration-300 group-hover:scale-110">
                <Icon className="w-6 h-6 text-blue-400" />
              </div>
               <h3 className="relative z-10 text-xl mb-3 text-white font-semibold transition-all duration-300 group-hover:text-blue-300">
                {feature.title}
              </h3>
              <p className="relative z-10 text-gray-400 text-sm leading-6 transition-colors duration-300 group-hover:text-gray-300">{feature.description}</p>
            </div>
          );
        })}
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-lg bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">CollabCode</span>
              </div>
              <p className="text-sm text-gray-400">Real-time collaborative code editor for modern teams.</p>
            </div>
